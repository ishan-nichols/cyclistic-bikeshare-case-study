...
q1_2019 <- Divvy_Trips_2019_Q1...Divvy_Trips_2019_Q1
q1_2020 <- Divvy_Trips_2020_Q1...Divvy_Trips_2020_Q1
...
as.numeric(all_trips$ride_length)
...
all_trips_v2 %>% 
  ...
  arrange(member_casual, weekday) #calculates the number of rides and average duration
