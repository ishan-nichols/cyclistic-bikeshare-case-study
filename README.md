...
How do casual and annual members use Cyclistic bikes differently, and what recommendations can we make to increase annual memberships based on the analysis?
...
Knit the RMD to generate the full HTML/PDF report.
